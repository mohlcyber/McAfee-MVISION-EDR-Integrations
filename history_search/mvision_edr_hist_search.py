...
class EDR():
    ...
    def logout(self):
        r = requests.delete(self.base_url + '/identity/v1/login', headers=self.headers)
        print(r.json())


if __name__ == '__main__':
    usage = """python mvision_edr_hist_search.py -U <USERNAME> -H <HOSTNAME> -T <SEARCHTYPE> -D <DAYS> -L <MAX RESULTS>"""
