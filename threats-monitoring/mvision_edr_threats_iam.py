#!/usr/bin/env python3
# Written by mohlcyber v.0.9b (26.11.2021)
    ...
    def auth(self, user, pwd):
        try:
            ...
            payload = {
                ...
                "username": user,
                "password": pwd,
                "scope": "mi.user.investigate",
                "tenant_id": "" #this is an option to specify tenant id in case multiple tenats are assigned to the same user
            }
